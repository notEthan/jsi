...
module Scorpio
  module OpenAPI
    ...
    openapi_class = proc do |definitions_key|
      Scorpio.class_for_schema(Scorpio::JSON::Node.new_by_type(openapi_schema_doc, ['definitions', definitions_key]))
    end

    Document = Scorpio.class_for_schema(Scorpio::JSON::Node.new_by_type(openapi_schema_doc, []))
