module JSI
  module Util
    ...
    class AttrStruct
      ...
      class UnknownAttributeKey < AttrStructError
      end
      ...
      def initialize(attributes = {})
        ...
        unless bad.empty?
          raise UnknownAttributeKey, "unknown attribute keys: #{bad.map(&:inspect).join(', ')}"
        end
      ...
      def []=(key, value)
        ...
        unless self.attribute_keys.include?(key)
          raise UnknownAttributeKey, "unknown attribute key: #{key.inspect}"
        end
