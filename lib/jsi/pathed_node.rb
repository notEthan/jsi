...
module JSI
  ...
  module PathedNode
    ...
    # @return [Array<JSI::PathedNode>] an array of parent nodes above this one in the document
  ...
  module PathedArrayNode
    ...
    # @return [self, Enumerator]
    def each
      return to_enum(__method__) { jsi_node_content_ary_pubsend(:size) } unless block_given?
